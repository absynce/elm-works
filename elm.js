...
var _user$project$Main$liveCoding = _xarvh$elm_slides$Slides$md('\n# Live coding\n\n* elm-stand-up\n* Atom\n* Don\'t expect to understand everything (or appreciate all)\n* Relate to R#\n');
var _user$project$Main$developerHappiness = _xarvh$elm_slides$Slides$md('\n# ~~Why Elm?~~ Dev happiness\n\n* Reliable\n* Bug reports\n* Reduce JavaScript fatigue\n* Consistent libraries and documentation\n* Clean code\n* Refactoring is easy\n');
var _user$project$Main$cleanCode = _xarvh$elm_slides$Slides$md('\n# Clean code\n\n* Signals -> Subscriptions\n* One way to do most things\n');
var _user$project$Main$consistentLibrariesAndDocumentation = _xarvh$elm_slides$Slides$mdFragments(
	{
		ctor: '::',
		_0: '# Consistent libraries and documentation',
		_1: {
			ctor: '::',
			_0: '* [Auto/enforced semantic versioning](https://github.com/elm-lang/elm-package#publishing-updates)',
			_1: {
				ctor: '::',
				_0: '* [Package updates](https://github.com/elm-lang/elm-package/blob/master/README.md)\n```\nelm-package diff elm-lang/core 3.0.0 4.0.0\n```',
				_1: {
					ctor: '::',
					_0: '* Example documentation ([elm-lang/http](http://package.elm-lang.org/packages/elm-lang/http/latest))',
					_1: {ctor: '[]'}
				}
			}
		}
	});
var _user$project$Main$reduceJavaScriptFatigue = _xarvh$elm_slides$Slides$mdFragments(
	{
		ctor: '::',
		_0: '# Reduce JavaScript fatigue',
		_1: {
			ctor: '::',
			_0: '* [What is JS fatigue?](https://hackernoon.com/how-it-feels-to-learn-javascript-in-2016-d3a717dd577f)',
			_1: {
				ctor: '::',
				_0: '* No backward compatibility with JavaScript (not the same as interop)',
				_1: {
					ctor: '::',
					_0: '* Compile-time errors',
					_1: {
						ctor: '::',
						_0: '* [Packages](http://package.elm-lang.org/)',
						_1: {
							ctor: '::',
							_0: '* See consistent libraries and documentation',
							_1: {ctor: '[]'}
						}
					}
				}
...
var _user$project$Main$simplifiedQA = _xarvh$elm_slides$Slides$mdFragments(
	{
		ctor: '::',
		_0: '# Simplified QA',
		_1: {
			ctor: '::',
			_0: '* [The Perfect Bug Report](http://elm-lang.org/blog/the-perfect-bug-report)',
			_1: {
				ctor: '::',
				_0: '* Fewer regression bugs',
				_1: {
					ctor: '::',
					_0: '* See reliability and refactoring',
					_1: {ctor: '[]'}
				}
			}
		}
	});
var _user$project$Main$reliability = _xarvh$elm_slides$Slides$mdFragments(
	{
		ctor: '::',
		_0: '# Reliability',
		_1: {
			ctor: '::',
			_0: '\"No runtime exceptions in practice\"',
			_1: {
				ctor: '::',
				_0: '<blockquote class=\"twitter-tweet\" data-lang=\"en\"><p lang=\"en\" dir=\"ltr\">After 2 years and 200,000 lines of production <a href=\"https://twitter.com/elmlang?ref_src=twsrc%5Etfw\">@elmlang</a> code, we got our first production runtime exception.<br><br>(We wrote code that called Debug.crash and shipped it. That function does what it says on the tin. 😅)<br><br>In that period, our legacy JS code has crashed a mere 60,000 times.</p>&mdash; Richard Feldman (@rtfeldman) <a href=\"https://twitter.com/rtfeldman/status/961051166783213570?ref_src=twsrc%5Etfw\">February 7, 2018</a></blockquote>\n<script async src=\"https://platform.twitter.com/widgets.js\" charset=\"utf-8\"></script>\n',
				_1: {ctor: '[]'}
			}
		}
	});
var _user$project$Main$whyElm = _xarvh$elm_slides$Slides$md('\n# Why Elm?\n\n* Reliable\n* Simplified QA\n* Reduce JavaScript fatigue\n* Consistent libraries and documentation\n* Refactoring is easy\n* Clean code\n* Dev happiness\n');
var _user$project$Main$whyNotElm = _xarvh$elm_slides$Slides$mdFragments(
	{
		ctor: '::',
		_0: '# Why not Elm?',
		_1: {
			ctor: '::',
			_0: '* Not for throwaway projects',
			_1: {
				ctor: '::',
				_0: '* Not popular enough',
				_1: {
					ctor: '::',
...
var _user$project$Main$frontEndFrameworkComparisonCriteriaSlides = _xarvh$elm_slides$Slides$mdFragments(
	{
		ctor: '::',
		_0: '# Framework comparison criteria',
		_1: {ctor: '[]'}
	});
var _user$project$Main$frontEndFrameworkAlternativesSlides = _xarvh$elm_slides$Slides$mdFragments(
	{
		ctor: '::',
		_0: '# Front-end framework alternatives',
		_1: {
			ctor: '::',
			_0: '* AngularJS',
			_1: {
...
var _user$project$Main$beforeElmInHXSlide = _xarvh$elm_slides$Slides$mdFragments(
	{
		ctor: '::',
		_0: '# Before Elm in HX',
		_1: {
			...
			_1: {
				ctor: '::',
				_0: '* [lodashfp](https://github.com/lodash/lodash/wiki/FP-Guide)',
				_1: {
					ctor: '::',
					_0: '* ES Future/Flow/TypeScript evaluation',
					_1: {ctor: '[]'}
				}
			}
		}
	...
	A2(
		...
		},
		{
			...
			_0: A2(
				...
				{
					ctor: '::',
					_0: _elm_lang$html$Html_Attributes$alt('IWT Health Logo'),
					_1: {
						ctor: '::',
						_0: _elm_lang$html$Html_Attributes$class('iwt-logo'),
						_1: {
							ctor: '::',
							_0: _elm_lang$html$Html_Attributes$src('images/IWTLogo-800x177.png'),
							_1: {ctor: '[]'}
						}
					}
				},
...
var _user$project$Main$main = A2(
		...
		}),
	{
		...
		_1: {
			...
			_1: {
				ctor: '::',
				_0: _user$project$Main$beforeElmInHXSlide,
				_1: {
					ctor: '::',
					_0: _user$project$Main$whyNotElm,
					_1: {
						ctor: '::',
						_0: _user$project$Main$whyElm,
						_1: {
							ctor: '::',
							_0: _user$project$Main$reliability,
							_1: {
								ctor: '::',
								_0: _user$project$Main$simplifiedQA,
								_1: {
									ctor: '::',
									_0: _user$project$Main$refactoring,
									_1: {
										ctor: '::',
										_0: _user$project$Main$reduceJavaScriptFatigue,
										_1: {
											ctor: '::',
											_0: _user$project$Main$consistentLibrariesAndDocumentation,
											_1: {
												ctor: '::',
												_0: _user$project$Main$cleanCode,
												_1: {
													ctor: '::',
													_0: _user$project$Main$developerHappiness,
													_1: {
														ctor: '::',
														_0: _user$project$Main$liveCoding,
														_1: {ctor: '[]'}
													}
												}
											}
